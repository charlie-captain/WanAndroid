...
public abstract class BaseDialogFragment<V extends BaseContract.IBaseView,
        P extends BasePresenter> extends DialogFragment implements BaseContract.IBaseView {
