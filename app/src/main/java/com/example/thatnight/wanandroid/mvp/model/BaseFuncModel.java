...
public class BaseFuncModel extends BaseModel implements BaseFuncContract.IModel {
    ...
    public void getArticle(final boolean isRefresh, int page, final MvpBooleanCallback callback) {
        getArticle(Constant.URL_BASE + Constant.URL_ARTICLE + page + "/json", isRefresh, callback);
    }

    @Override
    public void getArticle(String url, final boolean isRefresh, final MvpBooleanCallback callback) {
